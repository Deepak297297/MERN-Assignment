...
export default function Nav() {
  return (
    <nav className="h-16 bg-gray-800 p-4 flex justify-between items-center">
      <div className="flex items-center">
        <h1 className="text-white text-xl font-bold mr-4">
          Hyrr <span className="hidden md:inline">Assignment</span>
        </h1>
        <div className="text-white">
          Deepak Raj <span className="hidden md:inline">(RA2011003030103)</span>
        </div>
      </div>
      <div>
        <Link
